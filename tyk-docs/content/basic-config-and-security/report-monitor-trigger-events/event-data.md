...
> **Note**: Circuit breaker events carry different data, see [Circuit Breakers](/docs/planningfor-production/ensure-high-availability/circuit-breakers/) see what is exposed
