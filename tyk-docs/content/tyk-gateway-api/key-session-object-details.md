...
* `monitor`: Rate monitor trigger settings. See the [Gateway Configuration monitor settings](/docs/tyk-configuration-reference/tyk-gateway-configuration-options/#a-name-monitor-a-monitor) for more details
